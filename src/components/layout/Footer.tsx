          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Información compartida matemática: Un proyecto educativo que se
                construye con todos desde 1992.
              </p>
              <div className="flex space-x-3">
                <Link
                  href="https://www.facebook.com/olimpiadamatematicauy"
                  target="_blank"
                ...
                <Link
                  href="https://x.com/olimpiadamat_uy"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Twitter"
                  className="bg-sky-600 text-white p-2 rounded-full hover:bg-sky-700 transition-colors"
                ...
                <Link
                  href="mailto:info@compartidauruguay.org"
                  aria-label="Email"
                  className="bg-sky-600 text-white p-2 rounded-full hover:bg-sky-700 transition-colors"
                >
                  <svg
            ...
            <div>
              <h4 className="font-inter font-semibold text-gray-800 mb-4 text-md">
                Conócenos
              </h4>
      ...
      <div className="bg-sky-700 text-white py-4 text-center">
        <div className="container mx-auto px-4">
          <p className="text-sm mb-2">
            Copyright © {currentYear} Com-Partida de Matemática del Uruguay |
