...
export const metadata = buildStaticPageMetadata("/como-son-los-selectivos");
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-8">
              Información sobre las pruebas selectivas para representar a
              Uruguay en competencias internacionales
            </p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Las pruebas selectivas para representar a Uruguay en las
                      olimpiadas internacionales de matemática tienen
                      características específicas diseñadas para evaluar el
                      conocimiento matemático, la creatividad y las habilidades
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-sky-50 p-6 rounded-lg border border-sky-200">
                      ...
                      <p className="text-gray-700">
                        Cada prueba selectiva tiene una duración de{" "}
                        <span className="font-bold">3 horas</span>, durante las
                        cuales los estudiantes deben resolver los problemas
                        propuestos.
                      </p>
                    </div>
                    ...
                    <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
                      ...
                      <p className="text-gray-700">
                        Se presentan{" "}
                        <span className="font-bold">4 problemas</span> en cada
                        prueba, abarcando diferentes áreas de la matemática.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                    ...
                    <p className="text-gray-700 mb-3">
                      Los problemas abarcan diversas áreas de la matemática
                      olímpica, incluyendo:
                    </p>
                  ...
                  <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                    ...
                    <p className="text-gray-700">
                      <span className="font-bold">Es fundamental</span>{" "}
                      presentar soluciones completas con
                      <span className="font-bold">
                        {" "}
                        demostraciones rigurosas
                      </span>
                      . No basta con dar una respuesta; se debe justificar cada
                      paso del razonamiento matemático utilizado. Las soluciones
                  ...
                  <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                    ...
                    <p className="text-gray-700">
                      Para participar en los selectivos, existen ciertas
                      condiciones y requisitos que deben cumplirse. Estas
                      normativas son establecidas y publicadas oficialmente por
                      la Com-Partida de Matemática del Uruguay previo a los
                      selectivos. Te recomendamos consultar los requisitos en el
                      sitio oficial.
                    </p>
                  </div>
                </div>
            ...
            <Card className="mb-8 border-t-4 border-yellow-500 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6">
                  Para familiarizarte con el formato y el nivel de dificultad de
                  los selectivos, puedes consultar las pruebas de años
                  anteriores:
                </p>
                ...
                <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <p className="text-sm text-gray-700">
                    <span className="font-bold text-blue-700">💡 Consejo:</span>{" "}
                    En la sección de{" "}
                    <Link
                      href="/nacional"
                    ...
                    podrás encontrar más ejemplos y recursos para tu
                    preparación.
                  </p>
                </div>
              </CardContent>
            ...
            <div className="bg-gradient-to-r from-sky-50 to-blue-50 p-8 rounded-lg shadow-sm border border-sky-200">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="bg-sky-100 rounded-full p-5 md:p-6 flex-shrink-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 md:h-12 md:w-12 text-sky-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="text-center md:text-left flex-1">
                  <h3 className="text-xl font-bold text-sky-700 mb-3">
                    ¿Cuándo se realizan los selectivos?
                  </h3>
                  <p className="mb-4 text-gray-700">
                    Las fechas de las pruebas selectivas se publican en nuestro
                    calendario oficial. Consulta allí para conocer las próximas
                    convocatorias y no perderte ninguna oportunidad.
                  </p>
                  <Link
