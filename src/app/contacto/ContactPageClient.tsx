                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="text-center p-6 bg-sky-50 rounded-lg">
                      ...
                      <p className="text-gray-600 mb-4">
                        Si eres coordinador de un centro educativo o deseas
                        convertirte en uno
                      </p>
                      <a
            ...
            <section className="mt-12 mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h3 className="font-medium text-lg text-sky-700">
                    ¿Cómo puedo participar en las olimpiadas matemáticas?
                  </h3>
                  ...
                  {isSuccess ? (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center animate-in fade-in duration-500">
                      ...
                      <p className="text-green-700 mb-6">
                        Hemos recibido tu mensaje correctamente. Agradecemos tu
                        tiempo para ayudarnos a mejorar.
                      </p>
                      <button
                    ...
                    >
                      ...
                      <input
                        type="hidden"
                        name="_subject"
                        value="Nueva sugerencia de mejora - Web Ex-Olímpicos"
                      />
