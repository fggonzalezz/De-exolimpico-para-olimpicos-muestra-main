...
export default function PruebasSemanalesClient() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-sky-100 mt-4 max-w-2xl mx-auto">
                Ejercicios seleccionados para mejorar tus habilidades
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                ¿Cómo utilizar los problemas semanales?
              </h2>
              <p className="text-gray-600 mb-8">
                Estos problemas han sido cuidadosamente seleccionados para
                ayudarte a desarrollar habilidades matemáticas progresivamente.
                Te recomendamos dedicar al menos 3 horas semanales a resolver
                estos ejercicios.
              </p>
