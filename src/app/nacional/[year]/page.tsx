        ...
        <section className="py-10">
          <div className="container mx-auto px-4">
            {year !== "2020" && (
              <div className="flex flex-col md:flex-row items-center gap-8 bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <Link
                    href={`/nacional/${year}/primera`}
                    className="inline-block bg-sky-700 text-white font-bold py-2 px-6 rounded-full hover:bg-sky-800 transition-all"
                  >
                    Ver soluciones
                  </Link>
                </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 bg-[#f0f6fa] rounded-2xl shadow-lg p-8">
              ...
              />
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-[#6b8b93] mb-2">
                  RESOLUCIÓN SEGUNDA INSTANCIA
                </h2>
                <Link
                  href={`/nacional/${year}/segunda`}
                  className="inline-block bg-white text-[#6b8b93] font-bold py-2 px-6 rounded-full border border-[#6b8b93] hover:bg-[#e6eef0] transition-all"
                >
                  Ver soluciones
                </Link>
              </div>
