          ...
          <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center">
                  <div className="flex items-center text-yellow-600 mr-2">
                    ...
                    >
                      ...
                      <path
                        d="M12,2A7,7,0,1,0,19,9,7,7,0,0,0,12,2Zm0,12a5,5,0,1,1,5-5A5,5,0,0,1,12,14Z"
                        fill="currentColor"
                      />
                      <path
                        d="M14.5,19l-2.5-2l-2.5,2l.5-3l-2-2,3-.5L12,11l1,2.5l3,.5l-2,2Z"
                        fill="currentColor"
                      />
                    </svg>
            ...
            {resultados.map((yearData) => (
              <section
                key={yearData.year}
                className="mb-10"
                aria-labelledby={`heading-${yearData.year}`}
              >
                <h2
                ...
                <div className="space-y-6">
                  {yearData.competitions.map((competition) => (
                    <Card
                      key={`${yearData.year}-${competition.name}`}
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                          {competition.team.map((member) => (
                            <div
                              key={`${competition.name}-${member.name}`}
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left flex-1">
                  ...
                  <p className="mb-4 text-gray-700">
                    ...
                    Matemática desde 1997, y ha obtenido hasta el momento{" "}
