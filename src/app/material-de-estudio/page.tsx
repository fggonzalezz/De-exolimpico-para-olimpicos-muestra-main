...
export const metadata = buildStaticPageMetadata("/material-de-estudio");
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
                Accede a nuestra colección completa de recursos, problemas y
                material educativo para prepararte para las olimpiadas de
                matemática
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
              <Card className="border-t-4 border-sky-500">
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className="bg-sky-100 rounded-lg p-2 sm:p-3 flex-shrink-0"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm">
                        Material teórico completo sobre álgebra, geometría,
              ...
              <Card className="border-t-4 border-green-500">
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className="bg-green-100 rounded-lg p-2 sm:p-3 flex-shrink-0"
                      style={{ width: "44px", height: "44px" }}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm">
                        Colección de problemas con soluciones detalladas de
              ...
              <Card className="border-t-4 border-purple-500">
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className="bg-purple-100 rounded-lg p-2 sm:p-3 flex-shrink-0"
                      style={{ width: "44px", height: "44px" }}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm">
                        Guías sobre técnicas de resolución y estrategias para
                        competencias
                      </p>
                    </div>
                  </div>
              ...
              <Card className="border-t-4 border-amber-500">
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className="bg-amber-100 rounded-lg p-2 sm:p-3 flex-shrink-0"
                      style={{ width: "44px", height: "44px" }}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm">
                        Exámenes de práctica y simulacros de competencias
            ...
            <Card className="bg-gradient-to-br from-sky-50 to-blue-100 border-2 border-sky-300 shadow-lg">
              ...
              >
                <div className="max-w-2xl mx-auto">
                  <div
                    className="bg-white rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-md"
                  ...
                  <p className="text-gray-700 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg px-2">
                    Todo nuestro material de estudio está organizado en Google
                    Drive. Haz clic en el botón para acceder (se abrirá en una
                    nueva pestaña).
                  </p>
                  ...
                  >
                    <Button
                      size="lg"
                      className="bg-sky-600 hover:bg-sky-700 text-white shadow-lg w-full sm:w-auto text-sm sm:text-base md:text-lg font-semibold transition-colors duration-200"
                      style={{
                        height: "56px",
                        paddingLeft: "2rem",
                        paddingRight: "2rem",
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4 px-2">
                    💡 Tip: Puedes agregar el enlace a tus favoritos para
                    acceder más rápido
                  </p>
                </div>
              </CardContent>
