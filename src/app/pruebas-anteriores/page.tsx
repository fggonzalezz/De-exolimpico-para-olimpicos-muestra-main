...
export const metadata = buildStaticPageMetadata("/pruebas-anteriores");
        ...
        },
        {
          ...
          tests: [
            ...
            },
            {
              ...
              url: "https://drive.google.com/file/example9",
            },
            {
              name: "Tercera Instancia (Semifinal)",
              url: "https://drive.google.com/file/example10",
            },
            {
              name: "Cuarta Instancia (Final)",
              url: "https://drive.google.com/file/example11",
            },
          ],
        },
      ],
      ...
      competitions: [
        {
          ...
          tests: [
            {
              name: "Primer Día",
              url: "https://drive.google.com/file/example12",
            },
            {
              name: "Segundo Día",
              url: "https://drive.google.com/file/example13",
            },
          ],
        },
        {
          ...
          tests: [
            {
              name: "Primer Día",
              url: "https://drive.google.com/file/example14",
            },
            {
              name: "Segundo Día",
              url: "https://drive.google.com/file/example15",
            },
          ],
        },
        {
          ...
          tests: [
            {
              ...
              url: "https://drive.google.com/file/example16",
            },
            {
              name: "Prueba por Equipos",
              url: "https://drive.google.com/file/example17",
            },
          ],
        },
        {
          ...
          tests: [
            {
              name: "Primera Instancia",
              url: "https://drive.google.com/file/example18",
            },
            {
              name: "Segunda Instancia",
              url: "https://drive.google.com/file/example19",
            },
            {
              name: "Tercera Instancia (Semifinal)",
              url: "https://drive.google.com/file/example20",
            },
            {
              name: "Cuarta Instancia (Final)",
              url: "https://drive.google.com/file/example21",
            },
          ],
        },
      ],
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-8">
              Colección de pruebas de olimpiadas matemáticas nacionales e
              internacionales
            </p>
            ...
            <div className="bg-sky-50 p-6 rounded-lg mb-8">
              <p className="mb-4">
                Esta sección contiene las pruebas de olimpiadas matemáticas de
                años anteriores, organizadas por año y competencia. Son un
                recurso valioso para la preparación de futuros olímpicos.
              </p>
              <p>
                Te invitamos a utilizarlas como material de práctica para
                mejorar tus habilidades en la resolución de problemas
                matemáticos.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-8 flex items-start">
              ...
              <div>
                <p className="text-sm text-gray-700">
                  <span className="font-medium">Consejo:</span> Para encontrar
                  soluciones a estos problemas, te recomendamos consultar la
                  sección de "Seminarios de Exolímpicos" o el material de
                  estudio disponible en nuestro repositorio.
                </p>
              </div>
            </div>
                          ...
                          {competition.tests.map((test, i) => (
                            <li key={i}>
                              ...
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  className="h-5 w-5 text-sky-600 mr-3"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                                >
