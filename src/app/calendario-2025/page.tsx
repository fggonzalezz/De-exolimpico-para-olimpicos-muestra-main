...
export default function CalendarPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main id="main-content" className="flex-1 py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-3 sm:px-4 md:px-8">
          <div className="max-w-4xl mx-auto px-1 sm:px-2 md:px-8">
            ...
            <div className="mt-6 sm:mt-8 md:mt-10 text-center flex flex-col items-center gap-2 sm:gap-3 px-2">
              <p className="text-gray-500 text-xs sm:text-sm">Calendario actualizado periódicamente</p>
