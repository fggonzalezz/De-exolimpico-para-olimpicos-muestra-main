...
function MascotaCard({
  ...
  return (
    <div
      className={`max-w-2xl mx-auto flex flex-col md:flex-row items-center bg-sky-50 rounded-xl shadow-lg p-6 md:p-8 gap-6 md:gap-8 ${className}`}
    >
      ...
      <div className="text-center md:text-left">
        <h1 className="text-2xl md:text-3xl font-bold font-inter mb-2 text-sky-700">
          {name}
        </h1>
...
export default function MascotaPageClient() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="hero-mascota-surface force-light-surface py-8">
